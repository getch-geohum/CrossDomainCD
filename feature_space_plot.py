...
def argumentParser():
    ...
    parser.add_argument('--data_root', help='data folder, can be either with single task or multi task', type=str, required=False, default='/deep_feat_noabs')
    parser.add_argument('--save_dir', help = 'main root to save the test result', type = str, required=False, default='/deep_feat_plots_noabs')
